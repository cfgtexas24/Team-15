...
function JobListingList() {
  ...
  return (
    <section className='flex flex-col h-screen w-full bg-gray-200 px-16 pt-16 gap-8'>
      ...
      <div className='flex flex-col h-full w-full bg-white p-8 rounded-t-xl gap-8 overflow-y-scroll'>
        <div className='flex justify-between'>
          <h3 className='text-gray-900 text-2xl'>Listings</h3>
          <Button className='bg-[#FFC10C] text-xl'>Create New Listing</Button>
        </div>
        {dummy.map((dumdum) =>
