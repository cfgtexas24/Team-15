...
function JobListing(props) {
  return (
    <Link href="/">
      <section className="flex flex-col w-full h-auto bg-white border border-gray-300 shadow-[0px_0px_1rem_rgba(0,0,0,0.1)] hover:shadow-[0px_0px_1rem_rgba(0,0,0,0.2)] transition rounded-2xl p-4 gap-4">
